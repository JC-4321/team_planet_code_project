...
function calculateWeight(earthWeight) {
    ...
    // consolelog a phrase for each planet that states
    // itterate here
    for (let planet in planetweights) {
        conosle.log(`your weight in this ${planet} ${planetWeights[planet]}kg`);
    };
    // the user weight on that planet 
    // ex ur weight on mercury in kg
    // ur weight on venus is xxkg
    // console.log(planetWeights);
    // pound to kg conversion: 1 - 0.453592
}
